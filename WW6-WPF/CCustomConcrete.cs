...
namespace WinWam6
{
    public class CBusCustom : CCustomFields //,IVersion
    {
    ...
    public class CInsrCustom : CCustomFields
    {
        public override void Initialize()
        {
    ...
    public class CQSTCustom : CCustomFields
    {
        public override void Initialize()
        {
    ...
    public class CQST2Custom : CCustomFields
    {
        public override void Initialize()
        {
    ...
    public class CDeviceCustom : CCustomFields
    {
        public override void Initialize()
        {
    ...
    public class CDeviceInspectionCustom : CCustomFields
    {
        public override void Initialize()
        {
