...
namespace WinWam6
{
    class CDevice : INotifyPropertyChanged
    {
        ...
        public CDevice()
        {
            this.Custom = new CDeviceCustom();
        }

        public CDevice(int Ref)
        {
            lObj = WWD.GetTableWrapper("Device");
        ...
        public CDeviceCustom Custom { get; set; }
