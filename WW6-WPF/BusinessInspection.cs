...
namespace WinWam6
{
    ...
    class CBusInsps
    {
        private Dictionary<Int32, BusinessInspection> m_BusInsps;
        private bool m_Active;
        private string m_InspType;
        private bool m_IsDirty;
        private string m_Bus_ID;

        public Dictionary<Int32, BusinessInspection> BusInsps { get { return m_BusInsps; } set { m_BusInsps = value; m_IsDirty = true; } }
        public bool Active { get { return m_Active; } set { m_Active = value; m_IsDirty = true; } }
        ...
        public CBusInsps(string InspType, string Bus_ID)        //Initialize the collection
        {
            ...
            BusinessInspection cbi;

            m_InspType = InspType;
            m_Bus_ID = Bus_ID;

            m_BusInsps = new Dictionary<Int32, BusinessInspection>(); //Instantiate the dictionary
            ...
            while (rdrInsp.Read())
            {
                ...
                {
                    cbi = new BusinessInspection();                       // If it doesn't create a new one
                    cbi.Ref = lref;
                    BusInsps.Add(cbi.Ref, cbi);
                }
        ...
        public bool Save()
        {
            ...
            foreach(BusinessInspection lbi in BusInsps.Values)
            {
